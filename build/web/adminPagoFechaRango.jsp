    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-pills">
                ...
                <li role="presentation" class="active" ><a href="adminPagoFechaRango.jsp">Pagos especialistas por rango de fecha</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="form-group grupo"> 
                    <label class="control-label">General o por Especialista</label>    
                ...
                <div class="form-group grupo"> 
                    ...
                    <input name="fecha2" class="form-control" type="date"  step="1" min="2014-11-00" max="2015-00-00" value="2014-11-30">
                </div>
                <div class="form-group grupo"> 
        ...
        <script type="text/javascript">
            ...
            function iniciarBusqueda(){
                ...
                conexion.open("GET","busqueda2.jsp?rut="+rut+"&fecha="+fecha+"&fecha2="+fecha2,true);
