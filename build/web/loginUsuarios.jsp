<%-- 
    ...
    Created on : 17-11-2014, 03:05:37 PM
    Author     : cetecom
--%>
...
<html>
    ...
    <body>
        ...
        <form class="form-signin login" action="controllerLoginUsuario.jsp">
            <h3 class="form-signin-heading">Bienvenido/a Usuario,</h3>
            ...
            <a href="index.jsp" class="pull-left ">Ingresar como cliente </a>
        </form>
