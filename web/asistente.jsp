...
<html>
    ...
    <body>
        ...
        <div class="page-header">
            <h1>Cupos reservados <small>Seleccione una reserva que desee pagar</small></h1>
        </div>
        <button type="button" class="btn btn-default navbar-btn pull-right" onclick ="location='./controllerLogout.jsp'">Salir</button>
        <ul class="nav nav-pills">
            <li role="presentation" class="active"><a href="asistente.jsp">Horas reservadas</a></li>
        ...
        <div class="panel panel-default">
            ...
            %>
             <tr>
                 ...
                 <td>
                     <button type="button" class="btn btn-warning btn-block" onclick = "location='./ControllerPago.jsp?Id=<%=servicio.reservasTotales().get(i).getId() %>'">Pagar</button>
                 <td>
             </tr>
