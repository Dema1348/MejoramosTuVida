...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-pills">
            <li role="presentation" class="active" ><a href="sicologo.jsp">Citas programadas</a></li>
           
        </ul>
        <div class="panel panel-default">
            <div class="panel-heading">Si desea cancelar una hora comuniquese con la asistente</div>
            <table class="table">
                <tr>
                    <td>  
